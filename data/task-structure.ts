...
export const chapterTaskSections: ChapterTaskSection[] = [
  ...
  },
  {
    ...
    optionalSceneIds: ["c5-perspektive", "c5-peer-feedback", "c5-fallbeispiel", "c5-rueckblick"],
  },
  {
    id: "herausforderungen-passend-gestalten",
    order: 4,
    regularSceneIds: ["c4-differenzierung", "c4-steigerung", "c4-erfolge", "c4-situationselastisch", "c5-cta-uelc"],
